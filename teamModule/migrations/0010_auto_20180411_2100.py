      ...
      fields=[
        ('cmsplugin_ptr',
         models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                              primary_key=True, related_name='teammodule_projectdisplayview', serialize=False,
                              to='cms.CMSPlugin')),
        ('template', models.CharField(choices=[('teamModule/project_display.html', 'List projects')],
                                      default='projectModule/project_display.html', editable=False,
                                      max_length=255)),
