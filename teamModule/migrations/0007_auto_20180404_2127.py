  ...
  operations = [
      ...
      fields=[
        ('cmsplugin_ptr',
         models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                              primary_key=True, related_name='teammodule_teambannermodel', serialize=False,
                              to='cms.CMSPlugin')),
        ('template', models.CharField(choices=[('teamModule/member_banner.html', 'Default')],
                                      default='teamModule/member_banner.html', editable=False, max_length=255)),
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('master', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE,
                                     related_name='translations', to='teamModule.TeamBannerTranslationModel')),
      ],
      options={
    ...
    migrations.AddField(
      ...
      field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                              to='teamModule.TeamBannerTranslationModel'),
    ),
